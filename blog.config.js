...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xchen24.com', // 网站地址
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'www.linkedin.com/in/xingyu-chen-a14bb7288', // 你的linkedIn 首页
